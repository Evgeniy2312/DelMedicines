...
public class CustomUserDetails  implements UserDetails {
    ...
    public static CustomUserDetails fromUserEntityToCustomUserDetails(User userEntity) {
        List<GrantedAuthority> authorities = Collections.singletonList(new SimpleGrantedAuthority(userEntity.getRole().name()));
        return new CustomUserDetails(userEntity.getLogin(),
